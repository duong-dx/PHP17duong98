...
if (isset($_POST['updatenv'])) {
	...
	$employee_update_birthday = $_POST['employee_update_birthday'];
	$employee_update_mobile = $_POST['employee_update_mobile'];
	$demvipham=0;
	include_once('../../db_connect.php');
	$updatenv="UPDATE employees SET employee_code='$employee_update_code', employee_name='$employee_update_name', employee_address= '$employee_update_address', employee_email='$employee_update_email', employee_password='$employee_update_password', employee_mobile='$employee_update_mobile', employee_birthday='$employee_update_birthday'
