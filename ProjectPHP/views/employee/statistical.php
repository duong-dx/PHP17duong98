...
<hr style="border: 1px grey solid; margin:10% auto 5%;width: 80%;">
<div class="container">
	<h2 style="text-align: center;">Sinh nhật hôm nay</h2>
	<div class="row">

		<div style="margin-top: 5%;margin-bottom: 5%;" class="col-lg-6">
			<h5 style="margin-top: 5%;margin-bottom: 5%;" align="center">Nhân viên</h5>
			...
			<table id="myTable" class="table">
				...
				<tbody>
					...
					foreach ($employee_birthday_today as $row) {
						...
						<tr>
							...
							<td>
								<a href="?mod=employee&act=sendmail_nv&employee_code=<?= $row['employee_code']?>" class="btn btn-success">Send Mail</a> 
		...
		<div style="margin-top: 5%;margin-bottom: 5%;" class="col-lg-6">
			<h5 style="margin-top: 5%;margin-bottom: 5%;" align="center">Khách hàng</h5>
			...
			<table id="myTable2" class="table">
				...
				<tbody>
					...
					foreach ($customer_birthday_today as $row) {
						...
						<tr>
							...
							<td>
								<a href="?mod=employee&act=sendmail_kh&customer_code=<?= $row['customer_code']?>" class="btn btn-warning">Send Mail</a> 
