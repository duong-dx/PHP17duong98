...
<body>
	...
	<p>Mã khách hàng: <?php echo $customer_mail['customer_code'];?></p>
	<p>Tên khách hàng: <?php echo $customer_mail['customer_name'];?></p>
	<p>Địa chỉ khách hàng: <?php echo $customer_mail['customer_address'];?></p>
	<p>Địa chỉ khách hàng: <?php echo $customer_mail['customer_mobile'];?></p>
