...
<div class="container">
	...
	<h6>Tên khách hàng: <?php echo $customer_name['customer_name']; ?></h6>
	<h6>Địa chỉ khách hàng: <?php echo $customer_name['customer_address']; ?></h6>
	<table  style="text-align: right; margin-top: 5%;" id="myTable" >
		...
		<tbody>
			...
			<tr style="text-align: center; line-height: 100px;" height="100px">
				<td colspan="2"><?php echo $customer_name['customer_name']; ?></td>
				<td colspan="3"><?php echo $employee_name['employee_name']; ?></td>
