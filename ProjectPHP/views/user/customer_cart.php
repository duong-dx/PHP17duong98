							...
							<tr class="table-row">
								<td class="column-1">
									<div class="cart-img-product b-rad-4 o-f-hidden">
										<img src="public/images/product/<?php echo $product['product_image'] ?>" alt="IMG-PRODUCT">
									</div>
								</td>
								<td class="column-2"><?php echo $product['product_name']; ?></td>
								<td class="column-3"><?php echo number_format($product['product_price']);?>
								<td class="column-4">
									<div class="flex-w bo5 of-hidden w-size17">
										<a href="?mod=sale_online&act=remove_product&product_code=<?php echo $product['product_code']; ?>" class=" color1 flex-c-m size7 bg8 eff2">
										...
										<a href="?mod=sale_online&act=add2cart_online&product_code=<?php echo $product['product_code']; ?>" class="color1 flex-c-m size7 bg8 eff2">
								...
								<td class="column-5"><?php echo number_format($product['product_price']* $product['product_quantity']); ?></td>
								<td class="column-6"><a style="padding: 1% !important;" href="?mod=sale_online&act=unset_product_online&product_code=<?php echo $product['product_code']; ?>" class="color1 flex-c-m size7 bg8 eff2 deletecart">Unset</a></td>
							</tr>
							<?php 
						} ?>
