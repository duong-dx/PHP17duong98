		...
		<div class="container-menu-header">
				...
				<div class="topbar-child2">
					...
					<span class="topbar-email">
						<?php if (isset($_SESSION['customer_online'])) {
							echo $_SESSION['customer_online']['customer_email'];
						}
						else{
							echo "fashe@example.com";
						} ?>
					</span>
			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
							...
							<li>
								...
								<ul class="sub_menu">
									<?php foreach ($loai as $row) {
										?>
										<li><a href="?mod=user&act=category&category_code=<?php echo $row['category_code'] ?>"><?php echo $row['category_name']; ?></a></li>
									<?php 	# code...
								} ?>
						...
						<li>
							<a href="?mod=sale_online&act=profile_customer">Profile</a>
						</li>

						<li>
							<a href="javascript:;">Bill Status</a>
						</li>
			...
			<div class="header-icons">
				<a href="#" class="header-wrapicon1 dis-block">
					<?php if (isset($_SESSION['customer_online'])) {
						?>
						<img src="public/images/customer/<?php echo $_SESSION['customer_online']['customer_image']; ?>" class="header-icon1" alt="ICON">
						<?php 
