			...
			foreach ($data as $row) {
				...
				<tr>
					...
					<td>
						...
						<a href="?mod=category&act=detail&category_code=<?= $row['category_code']?>" class="btn btn-warning">Detail2</a> 
						<a href="?mod=category&act=edit&category_code=<?= $row['category_code']?>" class="btn btn-warning">Update</a>  
						<a href="?mod=category&act=delete&category_code=<?php echo $row['category_code']?>" class="btn btn-danger delete">Delete</a>
